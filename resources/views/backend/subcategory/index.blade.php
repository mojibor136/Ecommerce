    ...
    <div class="w-full mb-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center pb-4 border-b rounded-md mb-4">
            <div class="flex flex-col gap-2 w-full md:w-2/3">
                <h1 class="text-xl font-bold text-gray-800">Subcategory Management</h1>
            ...
            <div class="flex flex-row gap-2 mt-3 md:mt-0 w-full md:w-auto items-start sm:items-center">
                <a href="{{ route('admin.subcategories.create') }}"
                    ...
                    <i class="ri-add-line text-lg"></i> Add Subcategory
                </a>
            </div>
        </div>
            ...
            <table class="min-w-full table-auto">
                <thead class="bg-indigo-600 text-white text-sm font-semibold">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left whitespace-nowrap">Subcategory Name</th>
                ...
                <tbody class="text-sm text-gray-700 divide-y divide-gray-200">
                    @foreach ($subcategories as $index => $subcategory)
                        <tr class="hover:bg-gray-50 transition-colors cursor-pointer">
                            ...
                            <td class="px-4 py-3 text-left whitespace-nowrap">{{ $subcategory->slug }}</td>
                    ...
                    @if ($subcategories->isEmpty())
                        <tr>
                            <td colspan="6" class="py-4 px-3 text-center text-gray-400">No subcategories found.</td>
                        </tr>
                    @endif
                </tbody>
            </table>
