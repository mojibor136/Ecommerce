    ...
    <div class="w-full flex flex-col gap-4 mb-20">
        ...
        <div class="flex flex-col bg-white shadow rounded md:p-6 p-4 md:gap-1 gap-3">
            ...
            <div class="flex justify-between items-center text-gray-600 text-sm">
                <p>
                    <a href="{{ route('admin.dashboard') }}" class="text-blue-600 hover:underline">Home</a> / Review / Create
                </p>
                <a href="{{ route('admin.reviews.index') }}"
            ...
            <form action="{{ route('admin.reviews.store') }}" method="POST"
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="review" rows="4" placeholder="Write your review..."
                        class="w-full rounded-md bg-white text-gray-900 border px-3 sm:px-4 py-2 text-sm sm:text-base outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200 border-gray-300">{{ old('review') }}</textarea>
                </div>
