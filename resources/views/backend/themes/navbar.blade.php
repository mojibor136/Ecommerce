...
@section('content')
    ...
    <div class="w-full flex flex-col gap-4 mb-20">
        ...
        <form action="{{ route('admin.navbar.theme.update') }}" method="POST"
            ...
            <div class="flex flex-col gap-2 bg-gray-50 p-4 rounded-lg shadow-inner">
                ...
                <input type="color" id="nav_bg" name="nav_bg" value="{{ $theme->nav_bg ?? '#f5f5f5' }}"
                    class="color-input">
            </div>
            ...
            <div class="flex flex-col gap-2 bg-gray-50 p-4 rounded-lg shadow-inner">
                ...
                <input type="color" id="nav_text" name="nav_text" value="{{ $theme->nav_text ?? '#333333' }}"
                    class="color-input">
            </div>
