    ...
    <div class="w-full flex flex-col gap-4 mb-20">
        ...
        <div class="flex flex-col bg-white shadow rounded md:p-6 p-4 gap-3">
            ...
            <div class="flex flex-wrap justify-between items-center text-gray-600 text-sm gap-2">
                <p>
                    <a href="{{ route('admin.dashboard') }}" class="text-blue-600 hover:underline">Home</a> / Admin Account
                </p>
                <a href="{{ route('admin.dashboard') }}"
                    class="hidden sm:inline-flex items-center bg-indigo-600 text-white px-4 py-2 rounded font-medium hover:bg-indigo-700 transition">
                    Dashboard
                </a>
            </div>
        </div>
